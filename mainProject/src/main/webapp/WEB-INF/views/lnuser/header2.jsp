...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    $(document).ready(function(){
      ...
      <div class="site-navbar-top" >
        <div class="container">
          ...
          <div class="row align-items-center"  style="max-height:30px;">
            ...
            <input type="text" class="form-control border-0" data-toggle="modal" data-target="#myPopUp" placeholder="원하는 강의를 찾아보세요" onclick="getSearchRank();"> 
                   <!-- modal start -->
	  ...
	  <div class="modal-dialog">
		...
		<input type="text" class="form-control border-0" style="width: 100%;" id="searchLabel" placeholder="검색어 입력">
