...
<c:forEach items="${categoryList}" var="categoryVO">
        <label style="margin: 0 1 1 1;" for="${categoryVO.name }" class="btn btn-sm btn-primary" >${categoryVO.name }<input type="checkbox" checked="checked" name="categoryCheckBox2" id="${categoryVO.name }" value=${categoryVO.name } class="badgebox mr-3">
    ...
    <a  style="color: white;" class="text-center" href="#">${lectureVO.id }</a>
      ...
      <c:if test="${lectureVO.price == 0 }">
      	<div class="row my-3 text-center" style="font-weight: bold; justify-content: center;">
                ...
                <div class="row my-3 text-center" style="font-weight: bold; justify-content: center;">
 				   <a  style="color: white;" class="text-center" href="#">${lectureVO.cnt }명이  이 강의를 봤습니다.</a>
 			 </div>
 </div>
    </div>
  </div>
