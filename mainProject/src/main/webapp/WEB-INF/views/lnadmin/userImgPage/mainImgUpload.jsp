                        ...
                        <!-- ============================================================== -->
               			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                           	<div class="card" style="width: 80%; height: 100%;">	
                                <h5 class="card-header">메인화면 이미지 등록</h5>
                                <div class="card-body" align="right">
                                <form action="updateMainImage.do" method="post" id="form1" runat="server" enctype="multipart/form-data">
                                    <table class="table">
                                 		<thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                               	...
                                               	<td style="text-align: center;"><input type="file" id="imgInp1" name="imageFile1" style="height: 50%; width: 50%;"></td>
                                               	<td style="text-align: right;"><img style="height:50%; width:50%;"id="blah1" src="#" alt="your image" /></td>
                                    ...
                                    <input type="reset" style="font-size: 12px; width: 5%; padding-left: 0px; padding-right: 0px; margin-top: 0px;" class="btn btn-primary btn-lg btn-block" value="취소" onclick="location.href='mainImgUpload.go'">
                                </form>
                                </div>
                            </div>
						</div>
