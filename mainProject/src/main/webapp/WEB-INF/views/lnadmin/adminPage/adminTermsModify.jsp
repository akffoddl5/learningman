               			...
               			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card" style="width: 80%;">	
                                ...
                                <div class="card-body" align="right">
                                	<form action="modifyTerms.do" method="post">
                                		<input type="hidden" name="termsnum" value="${termsVO.termsnum}">
                                    	<table class="table">
                                 			<thead>
                                            	<tr>
                                        	...
                                        	<tbody>
                                            	<tr>
                                                	<th scope="row"><input type="text" value="${termsVO.termsname}" name="termsname"></th>
                                               		<td style="text-align: center;"><textarea name="termscontent" style="height: 150px; width: 50%;" >${termsVO.termscontent}</textarea></td>
                                         		</tr>
                                            </tbody>
                                    	</table>
